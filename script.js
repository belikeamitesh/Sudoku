...
//     xhrRequest.send()
// }
buttonEasy.onclick = async function() {
    let result = await fetch('https://sugoku.herokuapp.com/board?difficulty=easy')
...
//medium
buttonMedium.onclick = async function() {
    let result = await fetch('https://sugoku.herokuapp.com/board?difficulty=medium')
        .then(response => response.json())
        .then(data => {
            initializeTemp(temp)
            resetColor()
...
//hard
buttonHard.onclick = async function() {
    let result = await fetch('https://sugoku.herokuapp.com/board?difficulty=hard')
        .then(response => response.json())
        .then(data => {
            initializeTemp(temp)
            resetColor()
...
//random
buttonRandom.onclick = async function() {
    let result = await fetch('https://sugoku.herokuapp.com/board?difficulty=random')
        .then(response => response.json())
        .then(data => {
            initializeTemp(temp)
            resetColor()
